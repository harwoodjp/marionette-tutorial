...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(14), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
var ToDo = _backbone4.default.LayoutView.extend({
  tagName: "li",
  template: __webpack_require__(16)
});

var ToDoList = _backbone4.default.CompositeView.extend({
  childView: ToDo,
  ...
  onAddToDoItem: function onAddToDoItem() {
    this.collection.add({
...
var todo = new ToDoList({
  collection: new _backbone2.default.Collection([{ assignee: 'Justin', task: 'Learn about Backbone.js' }, { assignee: 'Justin', task: 'Learn about Marionette' }])
});
...
_backbone2.default.TemplateCache.prototype.compileTemplate = function (rawTemplate) {
    _mustache2.default.parse(rawTemplate);
    return _.partial(_mustache2.default.render, rawTemplate);
};
Backbone.Marionette.Renderer.render = function (template, data) {
    return _mustache2.default.to_html(template, data);
};
